(() => {
    ...
    document.addEventListener("click", (function(e) {
        ...
        if (window.innerWidth > 767.98) {
            ...
            if (!targetElement.closest(".header-catalog") && document.querySelector(".header-catalog._active")) document.querySelector(".header-catalog._active").classList.remove("_active");
        }
        if (window.innerWidth < 767.98) {
