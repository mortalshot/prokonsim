 ...
 */
    ...
    (() => {
        ...
        __webpack_require__.d(functions_namespaceObject, {
            FLS: () => functions_FLS,
            _slideDown: () => _slideDown,
            _slideToggle: () => _slideToggle,
            _slideUp: () => _slideUp,
            addLoadedClass: () => addLoadedClass,
            addTouchClass: () => addTouchClass,
            bodyLock: () => bodyLock,
            bodyLockStatus: () => bodyLockStatus,
            bodyLockToggle: () => bodyLockToggle,
            bodyUnlock: () => bodyUnlock,
            customCursor: () => customCursor,
            dataMediaQueries: () => dataMediaQueries,
            getDigFormat: () => functions_getDigFormat,
            getDigFromString: () => getDigFromString,
            getHash: () => getHash,
        ...
        function functions_getDigFormat(item, sepp = " ") {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".widget-catalog__slider")) {
                ...
                if (widgetSlider) {
                    new swiper_core_Swiper(".widget-catalog__slider .swiper", {
                        modules: [ Navigation ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: "auto",
            ...
            if (document.querySelector(".widget-products__slider")) {
                ...
                if (widgetSlider.length > 0) widgetSlider.forEach((widgetSlider => {
                    new swiper_core_Swiper(widgetSlider, {
                        modules: [ Navigation ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".widget-events__slider")) new swiper_core_Swiper(".widget-events__slider", {
                modules: [],
                observer: true,
                observeParents: true,
                slidesPerView: 1.14,
            ...
            if (document.querySelector(".product-gallery__main")) if (document.querySelector(".product-gallery__thumbs")) {
                const productThumbsSwiper = new swiper_core_Swiper(".product-gallery__thumbs", {
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
                    spaceBetween: 10,
                ...
                new swiper_core_Swiper(".product-gallery__main", {
            ...
            } else new swiper_core_Swiper(".product-gallery__main", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
...
***************************************************************************** */
        ...
        document.addEventListener("click", (function(e) {
            ...
            if (window.innerWidth > 767.98) {
                ...
                if (targetElement.classList.contains("header-contacts__more") || targetElement.closest(".header-contacts__more")) {
                    ...
                    if (document.querySelector(".header-contacts__item._active")) parent.classList.remove("_active"); else parent.classList.add("_active");
                }
                if (!targetElement.closest(".header-contacts__item") && document.querySelector(".header-contacts__item._active")) document.querySelector(".header-contacts__item._active").classList.remove("_active");
            }
            if (window.innerWidth < 767.98) {
            ...
            if (targetElement.classList.contains("location__close") || targetElement.closest(".location__close")) document.querySelector("body").classList.remove("_location-active");
            ...
            if (targetElement.classList.contains("product-item__action") || targetElement.closest(".product-item__action")) e.preventDefault();
            if (targetElement.classList.contains("catalog-menu__item") || targetElement.closest(".catalog-menu__item")) {
                ...
                parent.classList.add("_active");
            } else removeClasses(document.querySelectorAll(".catalog-menu__item._active"), "_active");
        }));
        if (window.innerWidth < 767.98) {
        ...
        if (document.querySelector(".personal__text .table")) {
            ...
            if (tableItems.length > 0) tableItems.forEach((element => {
                _slideUp(element, 0);
            }));
            const tableButtons = document.querySelectorAll("[data-link]");
            if (tableButtons.length > 0) tableButtons.forEach((button => {
        ...
        function noUiSliderInit() {
            ...
            if (sliders.length > 0) sliders.forEach((function(slider, index) {
                ...
                rangeSlider.on("update", (function(values, handle) {
                    ...
                    if (handle === 0) minInputs[index].value = formatValue(value, prefix); else maxInputs[index].value = formatValue(value, prefix);
                }));
                rangeSlider.on("change", (function(values, handle) {
                    var event = new Event("change");
                    if (handle === 0) minInputs[index].dispatchEvent(event); else maxInputs[index].dispatchEvent(event);
                }));
        ...
        window.flsFunctions = functions_namespaceObject;
    })();
})();